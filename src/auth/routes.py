...
from .schemas import UserCreateModel, UserModel, UserLoginModel, NewUser
...
@auth_router.post('/signup', response_model=NewUser, status_code=status.HTTP_201_CREATED)
...
async def login_users(login_data: UserLoginModel, session: AsyncSession = Depends(get_session)):
    ...
    if user is not None:
       password_valid = verify_password(password, user.passwd_hash)
